...
public class Portal1 : MonoBehaviour
{
    ...
    public static Vector3 TransformPositionBetweenPortals(Portal1 sender, Portal1 target, Vector3 position)
    {
        return
    ...
    public static Quaternion TransformRotationBetweenPortals(Portal1 sender, Portal1 target, Quaternion rotation)
    {
        return
